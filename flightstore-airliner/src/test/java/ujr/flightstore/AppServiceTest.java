...
public class ${atifactId}ServiceTest {
	
	/*
	
	@TestConfiguration
	static class ${atifactId}ServiceTestContextConfiguration {
		@Bean
		public ${atifactId}Service airplaneService() {
			return new ${atifactId}Service();
		}
	...
	@Autowired
	private ${atifactId}Service ${atifactId}Service;
