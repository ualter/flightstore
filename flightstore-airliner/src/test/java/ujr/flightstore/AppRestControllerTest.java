...
//@WebMvcTest(flightstore-airlinerRestController.class)
public class flightstore-airlinerRestControllerTest {
	...
	@MockBean
	private flightstore-airlinerService flightstore-airlinerService;
	@MockBean
