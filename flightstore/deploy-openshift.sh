...
curl -s http://$(oc get route flightstore-airliner -o json | jq -r .spec.host)/flightstore-airliner/api/v1/airlines/ | jq .
curl -s http://$(oc get route flightstore-airliner -o json | jq -r .spec.host)/flightstore-airliner/api/v1/airlines/1 | jq .
cd ..
